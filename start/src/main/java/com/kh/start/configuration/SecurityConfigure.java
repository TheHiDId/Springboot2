		...
		*/
		...
		return httpSecurity.formLogin(AbstractHttpConfigurer::disable)
						   ...
						   .authorizeHttpRequests(request -> {
							   ...
							   request.requestMatchers(HttpMethod.GET, "/uploads/**", "/boards/**", "/comments/**", "/comments").permitAll();
							   ...
							   request.requestMatchers(HttpMethod.PUT, "/members", "/boards/**").authenticated(); // 인가받은 사용자만
